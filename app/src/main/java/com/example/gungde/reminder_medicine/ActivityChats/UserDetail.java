        ...
        FirebaseDatabase.getInstance().getReference().child("Users").child(iduser).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (!image.equals("default")){
                    Picasso.with(UserDetail.this).load(image).networkPolicy(NetworkPolicy.OFFLINE)
                        ...
                        @Override
                        public void onError() {
                            Picasso.with(UserDetail.this).load(image).placeholder(R.drawable.default_avatar).into(mCircleImageView);

                        }
                    });

                }else{
                    Picasso.with(UserDetail.this).load(R.drawable.default_avatar).into(mCircleImageView);
